...
/*
	printf("%c\n", graph->vertices->next->vertex->data);
	printf("%c\n", graph->vertices->next->next->vertex->data);
	printf("%c\n", graph->vertices->next->next->next->vertex->data);

	printf("should be A and B : edgelist in A : %c and %c\n", graph->vertices->next->vertex->edgeList->next->edge->startPoint->data, graph->vertices->next->vertex->edgeList->next->edge->endPoint->data);
	printf("should be A and B : edgelist in graph : %c and %c\n", graph->edges->next->edge->startPoint->data, graph->edges->next->edge->endPoint->data);

	printf("should be A and B : edgelist1 in B : %c and %c\n", graph->vertices->next->next->vertex->edgeList->next->edge->startPoint->data, graph->vertices->next->next->vertex->edgeList->next->edge->endPoint->data);
	printf("should be B and C : edgelist2 in B : %c and %c\n", graph->vertices->next->next->vertex->edgeList->next->next->edge->startPoint->data, graph->vertices->next->next->vertex->edgeList->next->next->edge->endPoint->data);
	printf("should be B and C : edgelist in graph : %c and %c\n", graph->edges->next->next->edge->startPoint->data, graph->edges->next->next->edge->endPoint->data);
	printf("should be NULL : %p \n", graph->edges->next->next->next);
	printf("should be A and B and C : %c %c %c", graph->vertices->next->vertex->data, graph->vertices->next->next->vertex->data,graph->vertices->next->next->next->vertex->data);
printf("should be A and B : %c and %c in edge1 startpoint's edgelist\n", graph->edges->next->edge->startPoint->edgeList->next->edge->startPoint->data, graph->edges->next->edge->endPoint->edgeList->next->edge->endPoint->data);
